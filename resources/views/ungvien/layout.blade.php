			...
			<div class="col-sm-3 scroll bg-white fixed-top list-group" style="margin-top: 76px;">
				...
				<div class="card border-0 list-group-item">			
					<form class="form-signin ">
						...
						<input type="email" id="inputEmail"  style="margin-bottom: 3px;" class="form-control border-0" placeholder="Email" required autofocus>
						<label for="inputPassword" class="sr-only">Mật khẩu</label>
						<input type="password" id="inputPassword" class="form-control border-0" placeholder="Mật khẩu" required>
						<div class="list-inline">
							...
							<a class="list-inline-item" data-toggle="modal" data-target="#exampleModalCenter">
								Đăng ký 
							</a>
						</div>
					...
					<div class="row no-gutters ">
						...
						<div class="col">
							<div class="card-block px-2">
								...
								<p class="card-text">	<a href="" style="color:#6C757D;"> Từ Chí Thành</a></p>

								<p class="card-text">	<a href="" style="color:#6C757D;">Thoát</a></p>
							</div>
						</div>
					</div>
				</div>
